...
export default {
  ...
  search: function(searchTerm) {
    return axios.get(`https://www.googleapis.com/youtube/v3/search?part=snippet&key=AIzaSyCk7tdPP1tcVI4VYQS_ItYgO8WvkC3w-58&q=${searchTerm}&maxResults=20&type=video`);
  },
