...
const KEY = "AIzaSyA2CwBhl36OYF49p9RzRUUcVekMgEPxK6Y";
...
export default {
  ...
  search: function(searchTerm) {
    return axios.get(`https://www.googleapis.com/youtube/v3/search?part=snippet&key=${KEY}&q=${searchTerm}&maxResults=20&type=video`);
  },
